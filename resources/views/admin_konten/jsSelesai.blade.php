...
<table id="example" class="table" style="width:100%">
    ...
    <tbody>
        <tr>
            ...
            <td>Edinburgh</td>
            <td>
                <input class="form-control w-25" type="text" value="Selesai" aria-label="Disabled input example" disabled readonly>
            </td>
            <td>
                    ...
                    <div class="modal-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea type="text" class="form-control" id="formGroupExampleInput2" name="deskripsi_galeri" placeholder="" value=""></textarea>
                            </div>
                            </div>
