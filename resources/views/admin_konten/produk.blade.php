...
<a href="#" type="button" class="p-2 text-decoration-none fw-bolder rounded-top shadow " data-bs-toggle="modal" data-bs-target="#tambah" style="background-color:#4C6687;color:white"><i class="fa-solid fa-plus" style="color: #ffffff;"></i> Tambah Produk</a>
    ...
    <table id="example" class="table table-hover table-striped"  style="width:100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$row->harga}}</td>
                <td>
                    <a href="#" type="button" class="btn btn-sm btn-warning btn-primary w-100 shadow" data-bs-toggle="modal" data-bs-target="#edit{{$row->idProduk}}"><i class="fa-regular fa-pen-to-square"></i></a>
                    <a  href="#" type="button" class="mt-2 btn btn-sm btn-danger btn-primary w-100 shadow" data-bs-toggle="modal" data-bs-target="#hapus{{$row->idProduk}}"><i class="fa-solid fa-trash"></i></a>
                </td>
            </tr>
