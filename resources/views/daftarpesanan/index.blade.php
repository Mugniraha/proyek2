            ...
            <div>
                ...
                <ul class="list-group">
                    <li class="list-group-item"><a href="#">
                        <span class="fa fa-circle pr-1" id="semua"></span>Akun Saya
                    </a></li>
                    <li class="list-group-item"><a href="#">
                        <span class="fa fa-circle pr-1" id="meja"></span>Notifikasi
                    </a></li>
                    <li class="list-group-item"><a href="#">
                        <span class="fa fa-circle pr-1" id="kursi"></span>Daftar Pesanan
                    </a></li>
                    <li class="list-group-item"><a href="#">
                        <span class="fa fa-circle pr-1" id="tangga"></span>Whishlist
                    </a></li>
                </ul>
            </div>
        </section>
