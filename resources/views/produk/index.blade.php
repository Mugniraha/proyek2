            ...
            <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h7 class="card-text" style="color: rgb(0, 0, 0)">{{ $produk->id_produk }}</h7>
                        <h7 class="card-text">{{ $produk->nama_produk }}</h7>
                        <p>Lebar : {{ $produk->lebar }}</p>
                        <p>Panjang : {{ $produk->panjang }}</p>
                        <p>Tinggi: {{ $produk->tinggi }}</p>
                        <p>Bahan: {{ $produk->bahan }}</p>
                        <h6><i>RP. {{ $produk->harga }}</i></h6>
                        <div class="btn">
                            ...
                            <a href="{{ route('costumproduk.index', ['id_produk' => $produk->id_produk]) }}" class="btnord">
                                Order
                            </a>
                        </div>
                    </div>
