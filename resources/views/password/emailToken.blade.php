            ...
            <div class="card">
                ...
                <div class="card-header text-center">
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <h2 class="card-title">Ubah Password User</h2>
                ...
                <div class="card-body">
                    <form action="{{ route('password.update') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" name="password_confirmation" class="form-control" id="confirm_password" placeholder="Ulangi Password Baru" >
                        </div>
